...
const config: Config = {
  title: 'OG Tracker',
  tagline: 'Documentation for OG Tracker',
  favicon: 'img/favicon.ico',

  // Set the production url of your site here
  url: 'https://docs.ogtracker.io',
  ...
  organizationName: 'ogtracker', // Usually your GitHub org/user name.
  projectName: 'og-docs', // Usually your repo name.
  ...
  themeConfig: {
    ...
    colorMode: {
      ...
      disableSwitch: false, // Optional: allows users to switch between dark and light mode
